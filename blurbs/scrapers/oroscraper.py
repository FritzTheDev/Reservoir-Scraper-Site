...
def scrape():
  raw_html = simple_get(f'http://cdec.water.ca.gov/dynamicapp/QueryDaily?s=ORO&end={getLastSunday()}')
  html = BeautifulSoup(raw_html, 'html.parser')
  dataNodes = html.find_all("td", align="right")
  dataStrings = list(map(lambda x: x.string, dataNodes))
  slicedNodeList = [dataStrings[-104: -92], dataStrings[-91:-79], dataStrings[-78:-66], dataStrings[-65:-53], dataStrings[-52:-40], dataStrings[-39:-27], dataStrings[-26:-14], dataStrings[-13:]]
